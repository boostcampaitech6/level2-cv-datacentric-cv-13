...
class SceneTextDataset(Dataset):
    def __init__(self, fnames, data_dir,
                 split='train',
                 image_size=2048,
                 crop_size=1024,
                 ignore_tags=[],
        ...
        self.image_dir = osp.join(data_dir, 'img', split)
        # self.image_fnames = sorted(os.listdir(self.image_dir))
...
class ValSceneTextDataset(Dataset):
    def __init__(self, fnames, data_dir,
                 split='train',
                 image_size=2048,
                 crop_size=1024,
